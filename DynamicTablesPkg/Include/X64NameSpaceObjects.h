...
typedef enum X64ObjectID {
  ...
  EX64ObjFadtSciInterrupt,       ///<  1 - SCI Interrupt information
  EX64ObjFadtSciCmdInfo,         ///<  2 - SCI CMD information
  EX64ObjFadtPmBlockInfo,        ///<  3 - Power management block info
  EX64ObjFadtGpeBlockInfo,       ///<  4 - GPE block info
  EX64ObjFadtXpmBlockInfo,       ///<  5 - 64-bit Power Management block info
  EX64ObjFadtXgpeBlockInfo,      ///<  6 - 64-bit GPE block info
  EX64ObjFadtSleepBlockInfo,     ///<  7 - SLEEP block info
  EX64ObjFadtResetBlockInfo,     ///<  8 - Reset block info
  EX64ObjFadtMiscInfo,           ///<  9 - Legacy fields; RTC, latency, flush stride, etc
  EX64ObjMax
} E_X64_OBJECT_ID;
...
*/
typedef struct CmX64SciInterrupt {
...
*/
typedef struct CmX64SciCmdInfo {
...
*/
typedef struct CmX64PmBlockInfo {
  /** This is the System control interrupt command information of the FADT Table
      described in the ACPI Specification
  */
  UINT32    Pm1aEvtBlk;
...
*/
typedef struct CmX64GpeBlockInfo {
...
*/
typedef struct CmX64XpmBlockInfo {
  /** This is the System control interrupt command information of the FADT Table
      described in the ACPI Specification
  */
...
*/
typedef struct CmX64XgpeBlockInfo {
  /** This is the GPE Block information of the FADT Table
      described in the ACPI Specification
  */
...
*/
typedef struct CmX64SleepBlockInfo {
...
*/
typedef struct CmX64ResetBlockInfo {
...
*/
typedef struct CmX64FadtMiscInfo {
  UINT16    PLvl2Lat;
  UINT16    PLvl3Lat;
  UINT16    FlushSize;
  UINT16    FlushStride;
